...
public class RegistrarPedido implements RegistrarPedidoUseCase {
    ...
    public RegistrarPedido(IPedidoDatabaseAdapter pedidoDatabaseAdapter, IProdutoDatabaseAdapter produtoDatabaseAdapter, IPedidoQueueAdapterOUT pedidoQueueAdapterOUT) {
    ...
    public PedidoDto executar(PedidoDto pedidoDto) throws CupomExpiradoException, CupomInvalidoException, ProdutoNaoEncontradoException {
        ...
        pedidoQueueAdapterOUT.publish(toPedidoMessage(pedidoSalvo));
